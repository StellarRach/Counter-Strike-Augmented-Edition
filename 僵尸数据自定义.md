...
| 参数名 | 参数应用场景 |
| ------ | ---------- |
| forwardJump | 在空中，并且移动方向与击退方向（攻击方向）夹角大于 90°时 |
| jump | 在空中，并且没有水平速度时 |
| stand | 在地面上，且没有蹲下时 |
| duck | 在地面上蹲下时 |
...
| utStompSlow | 人类被送葬者棺材减速后的最大速度值 |
| witchCoolTime | 嗜血女妖诱捕技能的冷却时间 |
| witchBatLifeTime | 嗜血女妖蝙蝠的消失时间 |
| witchBatPullPower | 人类被嗜血女妖蝙蝠牵引的速度 |
...
| blowDamage | 自爆的伤害 |
| blowRadius | 自爆的伤害半径 |
| blowKickPowerRatio | 自爆的击退系数（基础值为 `150`） |
